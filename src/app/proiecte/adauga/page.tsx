...
export default function AdaugaNedeductibilPage() {
  ...
  const handleSave = async () => {
    ...
    if (!serviceName.trim()) {
      alert("Completează serviciul.");
      return;
    }

    if (!costRon || Number(costRon) <= 0) {
      alert("Completează un cost valid.");
      return;
    }
    ...
    setSaving(false);
    alert("Cheltuiala nedeductibilă a fost salvată.");
    router.push("/proiecte");
  };

  if (loading) {
    return <div className="p-6">Se încarcă proiectul...</div>;
  }
    ...
    <div className="min-h-screen bg-gray-100 p-4 md:p-6">
      <div className="mx-auto max-w-4xl">
        <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h1 className="text-2xl font-bold">Adaugă nedeductibil</h1>
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <div className="md:col-span-2">
              ...
              <input
                ...
                className="w-full rounded-lg border border-gray-300 px-4 py-3"
                placeholder="Ex: Taxă, protocol, servicii diverse..."
              />
            </div>
